...
Lifeup::Lifeup(float x, float y, float z,color_t color)
{
...
void Lifeup::draw(glm::mat4 VP, int disp) {
...
void Lifeup::set_position(float x, float y, float z) {
    this->position = glm::vec3(x, y, z);
}
